...
use Exception;
use Prokl\WpSymfonyRouterBundle\Services\Facades\RunController;
use Prokl\WpSymfonyRouterBundle\Services\Facades\RunRoute;
...
/**
 * Class WpSymfonyRouterExtension
 * @package Local\Bundles\WpSymfonyRouter\DependencyInjection
 *
 * @since 21.04.2021
 */
class WpSymfonyRouterExtension extends Extension
{
